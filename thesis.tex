...
Solids and liquids are generally viewed from a macroscopic perspective as continuous materials that can continuously deform in time. In \textit{infinitesimal strain theory} \citep{landauTheoryElasticityVolume1986}, the deformations are assumed small enough to not significantly affect the overall shape. However, in the case of soft materials, 

Furthermore many have internal degrees of freedom.

Classical theory of Cosserat brothers

The dynamics of such a system primarily deals with \textit{stresses}, which are the constitutive forces acting on such a system. In contrast to rigid body mechanics, such forces do not primarily act on displacements of the 
...
\citep{marsdenMathematicalFoundationsElasticity1994, wangIntroductionRationalElasticity1973, wangGeometricStructuresSimple1967, greenMechanicsNonlinearMaterials1957, lublinerMethodVirtualPower, yamaokaContinuumDynamicsVector2010, nollMathematicalTheoryMechanical1958}
